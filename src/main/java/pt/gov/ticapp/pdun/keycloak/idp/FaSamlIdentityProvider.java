...
import pt.gov.ticapp.pdun.keycloak.idp.saml.FaAuthnExtensionGenerator;
import pt.gov.ticapp.pdun.keycloak.idp.serialization.SerializationConverter;

/**
 * Based on code from <a href="https://github.com/grnet/eidas-keycloak-extension">eidas keycloak extension</a> and
 * Keycloak source code.
 */
public class FaSamlIdentityProvider extends SAMLIdentityProvider {

  private final DestinationValidator destinationValidator;

  public FaSamlIdentityProvider(KeycloakSession session, FaSamlIdentityProviderConfig faSamlIdentityProviderConfig,
      DestinationValidator destinationValidator) {

    super(session, faSamlIdentityProviderConfig, destinationValidator);
